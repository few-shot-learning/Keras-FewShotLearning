...
support_set = (
    train_set
    .assign(crop_coordinates=lambda df: df[['x1', 'y1', 'x2', 'y2']].agg(list, axis=1))
)
...
tray = img_to_array(load_img('/home/pielectronique/images/20151127115553_009901_091_0000000007_B____________1031_001_C.jpg')).astype(pd.np.uint8)
